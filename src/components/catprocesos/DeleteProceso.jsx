...
import { alertaglobal, deletematerialalta, deletematerialaltaerror, deletematerialbaja, deletematerialbajaerror } from '../alertas';

const DeleteProceso =  ({id_mat, onSuccess}) => {
