...
const EditCot = ({ cotizacion, id_cot, onSuccess }) => {
                    ...
                    <Form onSubmit={cotizar}>
                        <section className='mb-2'>
                            ...
                            <Form.Group controlId="id_clie" className="mb-2">
                                ...
                                <Form.Control type="text" name='id_clie' value={cotizaciones.id_clie} readOnly />
                            </Form.Group>
                        </section>
                        <section>
                            ...
                            <Form.Group controlId="id_prod" className="mb-3">
                                ...
                                <Form.Control type="text" name='id_prod' value={cotizaciones.id_prod} readOnly />
                            </Form.Group>
